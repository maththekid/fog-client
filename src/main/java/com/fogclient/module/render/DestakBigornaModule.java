...
public class DestakBigornaModule extends Module {
   private final Map<ChunkCoordIntPair, Set<BlockPos>> chunkAnvils = new HashMap();
   private final Set<ChunkCoordIntPair> scannedChunks = new HashSet();

   public DestakBigornaModule() {
      super("EncontraBigorna", "Highlights anvils (Unlimited Range).", Category.RENDER);
      this.keybind = 36;
   }

   public void onEnable() {
      this.chunkAnvils.clear();
   ...
   public void onTick() {
      if (this.isEnabled()) {
         ...
         if (var1.thePlayer != null && var1.theWorld != null) {
            ...
            this.chunkAnvils.keySet().removeIf((var1x) -> {
               return !var3.contains(var1x);
            });
   ...
   private void scanChunk(Chunk var1) {
            ...
            for(int var8 = 0; var8 < 16; ++var8) {
               for(int var9 = 0; var9 < 16; ++var9) {
                  for(int var10 = 0; var10 < 16; ++var10) {
                     if (var7.getBlockByExtId(var8, var9, var10) == Blocks.anvil) {
      ...
      if (!var2.isEmpty()) {
         this.chunkAnvils.put(var1.getChunkCoordIntPair(), var2);
      } else {
         this.chunkAnvils.remove(var1.getChunkCoordIntPair());
      }
   ...
   private void onRenderWorldLast(RenderWorldLastEvent var1) {
      if (this.isEnabled()) {
         ...
         if (var2.theWorld != null && var2.thePlayer != null) {
            ...
            Iterator var3 = this.chunkAnvils.values().iterator();
            ...
            while(var3.hasNext()) {
               ...
               while(var5.hasNext()) {
                  ...
                  this.renderAnvilESP(var6, var1.partialTicks);
               }
            }
   ...
   private void renderAnvilESP(BlockPos var1, float var2) {
